...
export function CardExpense({title, description, expenses, footer}: CardExpenseProps) {
    return (
        <Card>
            <CardHeader>
                ...
                <ul >
                    {expenses.map((expense) => (
                        <li className="my-2" key={expense.transaction_code}>
                            ...
                            <p className="text-sm font-light">To: {expense.payout.recipient_name} - {expense.timestamp.toDateString()}</p>
